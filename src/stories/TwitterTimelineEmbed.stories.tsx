...
import TwitterTimelineEmbed , {TwitterTimelineEmbedPropsType} from "./../components/TwitterTimelineEmbed";
...
export const TimelineWithNoheader = () => (
  <div className='centerContent'>
    <div className='selfCenter spaceBetween standardWidth'>
      <TwitterTimelineEmbed
        sourceType={'timeline'}
...
export const TimelineWithNofooter = () => (
  <div className='centerContent'>
    <div className='selfCenter spaceBetween standardWidth'>
      <TwitterTimelineEmbed
        sourceType={'timeline'}
